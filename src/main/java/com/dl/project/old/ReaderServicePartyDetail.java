...
public class ReaderServicePartyDetail implements ReaderService {

    @Override
    public DetailBasic getDetail(DetailRequest dRequest) {
        return getDetail(dRequest.getPartyId(),dRequest.getName());
    }


    private DetailBasic getDetail(UUID parentId, String attributeName) {
    ...
    private DetailBasic retrieveByNameAndParentId(UUID parentId,String name) {
