...
//            this.detailsListBuilder = detailFacade.getDetail(detailRequest);
    ...
    public Entity build(){
        return new Entity(id,detailsListBuilder,relationsListBuilder);
    }
}
